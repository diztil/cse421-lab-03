...
while True: # run continuously
    msg = input("Enter a message: ") # get user input for a message
    msg_to_be_sent(msg) # prepare the message in the correct format and send to server
    if msg == "Bye": # when the user sends message "Bye"
